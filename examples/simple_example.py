...
n = 10            # Size of the simulated sample.
nn = 5             # Neighbor size used for NNGP.
...
data_train, data_val, data_test = geospaNN.split_data(X, Y, coord, neighbor_size=20, test_proportion=0.2)
